...
namespace ExceptionWorkflow {
    ...
    public partial class ThrowWorkflow : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(ThrowWorkflow).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(ThrowWorkflow));
        ...
        private string FindResource() {
            string[] resources = typeof(ThrowWorkflow).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".ThrowWorkflow.g.xaml") || resource.Equals("ThrowWorkflow.g.xaml"))) {
                    return resource;
                }
            }
