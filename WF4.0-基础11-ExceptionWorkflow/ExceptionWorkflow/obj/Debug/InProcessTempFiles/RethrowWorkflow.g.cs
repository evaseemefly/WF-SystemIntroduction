...
namespace ExceptionWorkflow {
    ...
    public partial class RethrowWorkflow : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(RethrowWorkflow).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(RethrowWorkflow));
        ...
        private string FindResource() {
            string[] resources = typeof(RethrowWorkflow).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".RethrowWorkflow.g.xaml") || resource.Equals("RethrowWorkflow.g.xaml"))) {
                    return resource;
                }
            }
