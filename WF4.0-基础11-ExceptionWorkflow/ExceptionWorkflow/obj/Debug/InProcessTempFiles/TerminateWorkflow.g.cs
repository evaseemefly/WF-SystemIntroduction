...
namespace ExceptionWorkflow {
    ...
    public partial class TerminateWorkflow : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(TerminateWorkflow).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(TerminateWorkflow));
        ...
        private string FindResource() {
            string[] resources = typeof(TerminateWorkflow).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".TerminateWorkflow.g.xaml") || resource.Equals("TerminateWorkflow.g.xaml"))) {
                    return resource;
                }
            }
