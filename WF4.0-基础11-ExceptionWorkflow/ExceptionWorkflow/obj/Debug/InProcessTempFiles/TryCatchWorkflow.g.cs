...
namespace ExceptionWorkflow {
    ...
    public partial class TryCatchWorkflow : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(TryCatchWorkflow).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(TryCatchWorkflow));
        ...
        private string FindResource() {
            string[] resources = typeof(TryCatchWorkflow).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".TryCatchWorkflow.g.xaml") || resource.Equals("TryCatchWorkflow.g.xaml"))) {
                    return resource;
                }
            }
