...
namespace ExceptionWorkflow {
    ...
    public partial class ExceptionActivityWorkflow : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        public ExceptionActivityWorkflow() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(ExceptionActivityWorkflow).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(ExceptionActivityWorkflow));
        ...
        private string FindResource() {
            string[] resources = typeof(ExceptionActivityWorkflow).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".ExceptionActivityWorkflow.g.xaml") || resource.Equals("ExceptionActivityWorkflow.g.xaml"))) {
                    return resource;
                }
            }
