...
namespace controlActivitySample2 {
    ...
    public partial class PickWorkflow : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(PickWorkflow).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(PickWorkflow));
        ...
        private string FindResource() {
            string[] resources = typeof(PickWorkflow).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".PickWorkflow.g.xaml") || resource.Equals("PickWorkflow.g.xaml"))) {
                    return resource;
                }
            }
