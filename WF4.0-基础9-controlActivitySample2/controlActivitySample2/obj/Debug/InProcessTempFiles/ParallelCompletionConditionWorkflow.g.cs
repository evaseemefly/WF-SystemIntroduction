...
namespace controlActivitySample2 {
    ...
    public partial class ParallelCompletionConditionWorkflow : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public ParallelCompletionConditionWorkflow() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(ParallelCompletionConditionWorkflow).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(ParallelCompletionConditionWorkflow));
        ...
        private string FindResource() {
            string[] resources = typeof(ParallelCompletionConditionWorkflow).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".ParallelCompletionConditionWorkflow.g.xaml") || resource.Equals("ParallelCompletionConditionWorkflow.g.xaml"))) {
                    return resource;
                }
            }
