...
namespace controlActivitySample2 {
    ...
    public partial class ParallelWorkflow : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(ParallelWorkflow).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(ParallelWorkflow));
        ...
        private string FindResource() {
            string[] resources = typeof(ParallelWorkflow).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".ParallelWorkflow.g.xaml") || resource.Equals("ParallelWorkflow.g.xaml"))) {
                    return resource;
                }
            }
