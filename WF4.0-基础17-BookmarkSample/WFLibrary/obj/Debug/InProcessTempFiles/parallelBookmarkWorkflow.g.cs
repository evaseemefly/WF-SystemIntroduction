...
namespace WFLibrary {
    ...
    public partial class parallelBookmarkWorkflow : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public parallelBookmarkWorkflow() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(parallelBookmarkWorkflow).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(parallelBookmarkWorkflow));
        ...
        private string FindResource() {
            string[] resources = typeof(parallelBookmarkWorkflow).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".parallelBookmarkWorkflow.g.xaml") || resource.Equals("parallelBookmarkWorkflow.g.xaml"))) {
                    return resource;
                }
            }
