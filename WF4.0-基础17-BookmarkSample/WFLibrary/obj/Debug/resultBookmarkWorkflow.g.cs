...
namespace WFLibrary {
    ...
    public partial class resultBookmarkWorkflow : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        public resultBookmarkWorkflow() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(resultBookmarkWorkflow).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(resultBookmarkWorkflow));
        ...
        private string FindResource() {
            string[] resources = typeof(resultBookmarkWorkflow).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".resultBookmarkWorkflow.g.xaml") || resource.Equals("resultBookmarkWorkflow.g.xaml"))) {
                    return resource;
                }
            }
